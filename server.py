...
def readEDF(filepath, filldisrupt = False):
    ...
    for i in range(0, int(num_ten_min_intervals)):
        ...
        #print(f'psd of 10 min interval of channel 1: {ten_min_psd_ch1}')
        #print(f'psd of 10 min interval of channel 2: {ten_min_psd_ch2}')
        ...
        ten_min_ratios_ch1 = np.append(ten_min_ratios_ch1, avg_10hz_psd_ch1/avg_3hz_psd_ch1)
        ten_min_ratios_ch2 = np.append(ten_min_ratios_ch2, avg_10hz_psd_ch2/avg_3hz_psd_ch2)
